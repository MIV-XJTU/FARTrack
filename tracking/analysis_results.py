...
"""fartrack"""
trackers.extend(trackerlist(name='fartrack_sparse', parameter_name='fartrack_sparse_224_full', dataset_name=dataset_name,
                            run_ids=None, display_name='FARTrack-tiny-sparse224'))
