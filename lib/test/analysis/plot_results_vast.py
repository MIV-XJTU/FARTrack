...
from lib.test.analysis.extract_results_vast import extract_results
...
def print_results(results_dir, dataset, merge_results=False, plot_types=('success'), **kwargs):
    ...
    print(report_text)
    # 将报告保存到txt文件
    with open("/data5/FARTrack/main/fartrack/fartrack_sparse/VastTrack_eval_results.txt", "w", encoding="utf-8") as f:
        f.write(report_text)
