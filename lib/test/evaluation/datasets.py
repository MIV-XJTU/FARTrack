...
dataset_dict = dict(
    ...
    lasot_extension_subset=DatasetInfo(module=pt % "lasotextensionsubset", class_name="LaSOTExtensionSubsetDataset",
                                       kwargs=dict()),
    vasttrack=DatasetInfo(module=pt % "vasttrack", class_name="VastTrackDataset", kwargs=dict(base_path='/data3/VastTrack/test', txt_file_path='/data3/VastTrack/vasttrack_test_list.txt')), # new add
)
