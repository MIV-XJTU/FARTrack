...
class FARTrackSeqActor(BaseActor):
    ...
    def batch_init(self, images, template_bbox, initial_bbox) -> dict:
        ...
        for i in range(len(images)):
            ...
            for j in range(number):
                ...
                sequence_crops.append(z_crop.clone())
            sequence_tensor = torch.concat(sequence_crops, dim=0)
            z_crop_list.append(sequence_tensor.unsqueeze(0).clone())
    ...
    def explore(self, data):
      ...
      #  dz_feat_udpate_list = []
        ...
        template = data['template_images'] # 5 templates
