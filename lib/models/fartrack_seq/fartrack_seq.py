...
from lib.models.fartrack_seq.vit import vit_base_patch16_224, vit_large_patch16_224, vit_tiny_patch16_224
...
class FARTrackSeq(nn.Module):
    ...
    def __init__(self, transformer,
        ...
        # test speed
        self.identity = torch.nn.Parameter(torch.zeros(1, 2, 192)) # 2: 1 template + 1 search
...
def build_fartrack_seq(cfg, training=True):
    ...
    if cfg.MODEL.PRETRAIN_PTH and training:
