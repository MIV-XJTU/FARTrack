...
from lib.models.fartrack.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def forward_features(self, z_0, z_1, x, identity, seqs_input):
        ...
        z_ = self.patch_embed(z_0)  # [B*L, P, D] where Pis patches，D is embedding dim
